...
export class AddSkillAndPesertaSkillRelation1790227483996 implements MigrationInterface {
    name = 'AddSkillAndPesertaSkillRelation1790227483996'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "jurnal_harian" ALTER COLUMN "peserta_id" SET NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "jurnal_harian" DROP CONSTRAINT "FK_7f20e4df833360c0b09c15f8bc3"`);
        await queryRunner.query(`ALTER TABLE "jurnal_harian" ALTER COLUMN "peserta_id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "jurnal_harian" ADD CONSTRAINT "FK_7f20e4df833360c0b09c15f8bc3" FOREIGN KEY ("peserta_id") REFERENCES "peserta"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
