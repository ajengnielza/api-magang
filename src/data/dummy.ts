...
export const dataJurnal: Jurnal[] = [
  { id: 1, pesertaId: 1, tanggal: "2024-01-10", kegiatan: "Setup project", status: "selesai" },
  { id: 2, pesertaId: 1, tanggal: "2024-01-11", kegiatan: "Belajar routing", status: "belum" },
  { id: 3, pesertaId: 2, tanggal: "2024-01-10", kegiatan: "Review kode", status: "selesai" },
];

export let nextId = 5;

export const increaseNextId = (): number => {
  return nextId++;
};

export let nextJurnalId = 4;

export const increaseNextJurnalId = (): number => {
  return nextJurnalId++;
};